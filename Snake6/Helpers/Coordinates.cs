...
//     internal static Coordinates right;
...
//     public static Coordinates operator *(int scalar, Coordinates coord) => new Coordinates(coord.column * scalar, coord.row * scalar);
//     public static Coordinates operator *(Coordinates coord, int scalar) => new Coordinates(coord.column * scalar, coord.row * scalar);
